        ...
        <main>
            <div class="container-fluid px-4">
                ...
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item"><a style="text-decoration: none" href="/project_9_web/admin/index">Trang chủ</a></li>
                    <li class="breadcrumb-item active"><a style="text-decoration: none; color: black" href="/project_9_web/admin/milk-tea-category-update">Cập nhật danh mục trà sữa</a></li>
                </ol>
                <div class="card mb-4">
                    <form class="mt-3 ms-3 me-3 mb-3" action="/project_9_web/admin/milk-tea-category-update/create" method="post">
                        <!-- ID Category -->
                        <div class="mb-3">
                        ...
                        <div class="text-end">
                            <button type="submit" class="btn btn-primary" formaction="/project_9_web/admin/milk-tea-category-update/create" ${buttonnolog}>Thêm</button>
                            <button type="submit" class="btn btn-success" formaction="/project_9_web/admin/milk-tea-category-update/update" ${buttonlog}>Sửa</button>
                            <button type="submit" class="btn btn-danger" formaction="/project_9_web/admin/milk-tea-category-update/delete" ${buttonlog1} ${buttonxoa}>Xóa</button>
                        </div>
                    </form>
