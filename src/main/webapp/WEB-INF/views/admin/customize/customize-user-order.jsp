        ...
        <main>
            <div class="container-fluid px-4">
                ...
                <ol class="breadcrumb mb-4">
                    ...
                    <li class="breadcrumb-item active"><a style="text-decoration: none; color: black" href="/admin/user-order-update">Cập nhật đơn hàng</a></li>
                </ol>
                <div class="card mb-4">
                    <form class="mt-3 ms-3 me-3 mb-3" action="/admin/user-order-update/create" method="post">
                        <!-- ID Order -->
                        <div class="mb-3">
                        ...
                        <div class="text-end">
                            <button type="submit" class="btn btn-primary" formaction="/admin/user-order-update/create" ${buttonnolog}>Thêm</button>
                            <button type="submit" class="btn btn-success" formaction="/admin/user-order-update/update" ${buttonlog}>Sửa</button>
                            <button type="submit" class="btn btn-danger" formaction="/admin/user-order-update/delete" ${buttonlog1} ${buttonxoa}>Xóa</button>
                        </div>
                    </form>
