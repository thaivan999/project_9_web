...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <li class="breadcrumb-item active"><a style="text-decoration: none; color: black" href="/ASM_Java4/admin/user-ctr">Danh sách người dùng</a></li>
                    </ol>
                    <div class="card mb-4">
                        <div class="card-header">
                            <i class="fas fa-table me-1"></i>BẢNG DANH SÁCH NGƯỜI DÙNG
        ...
        function exportToWord() {
            ...
            a.href = url;
            a.download = 'Danh Sách Người Dùng.doc';
