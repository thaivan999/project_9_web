            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item active"><a style="text-decoration: none; color: black" href="/admin/view-account">Danh sách tài khoản</a></li>
                    </ol>
                    <div class="card mb-4">
                                ...
                                <tbody>
                                    <c:forEach var="item" items="${account}">
                                        <tr>
                                            ...
                                            <td>${item.idRole}</td>
                                            <td>${item.idBranch}</td>
                                            <td><a class="btn btn-success" href="/admin/customize-account/edit/${item.id_account}">edit</a></td>
                                        	<td><a class="btn btn-danger" href="/admin/customize-account/delete/${item.id_account}">delete</a></td>
