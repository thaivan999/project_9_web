        ...
        <div class="container-fluid px-4">
            ...
            <div class="card mb-4">
            	<ol class="breadcrumb mb-4">
                    ...
                    <li class="breadcrumb-item active"><a style="text-decoration: none; color: black" href="/manager/view-user-order">Danh sách đơn hàng người dùng</a></li>
                </ol>
            	<div class="card mb-4">
                	<div class="card-header">
                    	<i class="fas fa-table me-1"></i>BẢNG DANH SÁCH ĐƠN HÀNG NGƯỜI DÙNG
                	...
                	<div class="card-body">
                    	<div class="table-responsive">
                        	<table class="table table-bordered" id="userOrdersTable">
                            	...
                            	<tbody>
                                	<c:forEach var="userorder" items="${paymethod}">
                                    	<tr>
                                        	<td>${userorder.id_type}</td>
