...
<body>
     ...
     <div class="content" style="margin-top: 80px">
        <div class="message" style="color:blue">${message}</div>
        ...
        <div class = "user-infor-container">
            <form action="/user_infor/edit/${user.id}" method="post">
                ...
                <input type="text" class = "user-lastname-textbox textbox" name="name" value="${user.name}" required placeholder="Tên khách hàng">
                <input type="text" class = "user-surname-textbox textbox" name = "surname" value="${user.surname}" required placeholder="Họ khách hàng">
                </div>
    
                <div class = "user-infor user-phone">Số điện thoại</div>
                <input type="tel" id="phone" class = "user-phone-textbox textbox" name = "phoneNumber" value="${user.phoneNumber}" pattern="0\d{9}" required>
